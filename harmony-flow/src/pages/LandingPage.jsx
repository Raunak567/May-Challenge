...
const LandingPage = () => {
  ...
  return (
    <div className="bg-[#0f0f13] text-[#f1f1f1] font-[Poppins]">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:block">
              <div className="flex space-x-4">
                <button className="text-white px-4 py-2 rounded-full text-sm font-medium hover:bg-black hover:bg-opacity-5 transition">Login</button>
                <button className="bg-gradient-to-r from-[#6e00ff] to-[#ff00cc] text-white px-4 py-2 rounded-full text-sm font-medium hover:opacity-90 transition">Sign Up</button>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <button className="bg-gradient-to-r from-[#6e00ff] to-[#ff00cc] text-white px-8 py-4 rounded-full text-lg font-medium hover:opacity-90 transition flex items-center justify-center">
            <i className="fas fa-play mr-2"></i> Start Listening Now
          </button>
      ...
      <section id="features" class="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div class="text-center mb-16">
            ...
            <p class="text-gray-400 max-w-2xl mx-auto">Harmoniq combines cutting-edge technology with intuitive design to revolutionize your music experience.</p>
        </div>
        
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div class="glass-card p-6 rounded-xl hover:bg-white hover:bg-opacity-10 transition">
                <div class="w-12 h-12 gradient-bg rounded-lg flex items-center justify-center mb-4">
                    <i class="fas fa-brain text-white text-xl"></i>
                </div>
                <h3 class="text-xl font-semibold mb-2">AI Music Recommendations</h3>
                <p class="text-gray-400">Our advanced AI learns your taste and suggests perfect tracks you'll love, even before you know you want them.</p>
            </div>
            ...
            <div class="glass-card p-6 rounded-xl hover:bg-white hover:bg-opacity-10 transition">
                ...
                <h3 class="text-xl font-semibold mb-2">Smart Tagging System</h3>
                <p class="text-gray-400">Organize your library with custom tags for mood, activity, or any category you choose. Auto-tagging available.</p>
            </div>
            ...
            <div class="glass-card p-6 rounded-xl hover:bg-white hover:bg-opacity-10 transition">
                ...
                <h3 class="text-xl font-semibold mb-2">Dynamic Sound Profiles</h3>
                <p class="text-gray-400">Adaptive audio processing that automatically adjusts EQ and effects based on genre, tags, and your preferences.</p>
            </div>
            ...
            <div class="glass-card p-6 rounded-xl hover:bg-white hover:bg-opacity-10 transition">
                ...
                <h3 class="text-xl font-semibold mb-2">Collaborative Playlists</h3>
                <p class="text-gray-400">Create shared playlists with friends where everyone can add tracks and vote on what plays next.</p>
            </div>
               ...
               <div class="glass-card p-6 rounded-xl hover:bg-white hover:bg-opacity-10 transition">
                ...
                <h3 class="text-xl font-semibold mb-2">Sleep Timer & Fade</h3>
                <p class="text-gray-400">Fall asleep to your favorite music with customizable fade-out and automatic shut-off after your chosen duration.</p>
            </div>
            ...
            <div class="glass-card p-6 rounded-xl hover:bg-white hover:bg-opacity-10 transition">
                ...
                <p class="text-gray-400">Detailed insights into your listening habits, mood patterns, and musical preferences over time.</p>
            </div>
        </div>
    </section>

      {/* How It Works Section */}
    <section id="how-it-works" class="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-gradient-to-b from-purple-900/10 to-transparent">
        <div class="text-center mb-16">
            <h2 class="text-3xl md:text-4xl font-bold mb-4">How Harmoniq Works</h2>
            <p class="text-gray-400 max-w-2xl mx-auto">Three simple steps to transform your music experience</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="text-center">
                ...
                <h3 class="text-xl font-semibold mb-2">Connect Your Music</h3>
                <p class="text-gray-400">Link your existing music library from Spotify, Apple Music, or upload your own files. We support all major platforms.</p>
            </div>
            

            <div class="text-center">
                <div class="w-20 h-20 gradient-bg rounded-full flex items-center justify-center mx-auto mb-6 text-2xl font-bold">2</div>
                <h3 class="text-xl font-semibold mb-2">Personalize Your Experience</h3>
                <p class="text-gray-400">Teach our AI your preferences by liking tracks, adding tags, and creating playlists. The more you use it, the smarter it gets.</p>
            </div>
            

            <div class="text-center">
                <div class="w-20 h-20 gradient-bg rounded-full flex items-center justify-center mx-auto mb-6 text-2xl font-bold">3</div>
                <h3 class="text-xl font-semibold mb-2">Discover & Enjoy</h3>
                <p class="text-gray-400">Let Harmoniq surprise you with perfect recommendations and automatically organized playlists tailored to your current mood.</p>
            </div>
        </div>
        ...
        <div class="mt-16 glass-card p-8 rounded-2xl">
            <div class="flex flex-col md:flex-row items-center gap-8">
                <div class="flex-grow">
                    <h3 class="text-2xl font-bold mb-4">AI That Understands Your Taste</h3>
                    <p class="text-gray-400 mb-6">Our proprietary machine learning algorithms analyze not just the musical characteristics of your favorite tracks, but also when and how you listen to them, creating a multidimensional understanding of your unique musical identity.</p>
                    <div class="flex flex-wrap gap-2">
                        <span class="tag px-3 py-1 bg-purple-900 bg-opacity-40 rounded-full text-sm">Tempo Analysis</span>
                        <span class="tag px-3 py-1 bg-blue-900 bg-opacity-40 rounded-full text-sm">Harmonic Mapping</span>
                        <span class="tag px-3 py-1 bg-pink-900 bg-opacity-40 rounded-full text-sm">Mood Detection</span>
                        <span class="tag px-3 py-1 bg-yellow-900 bg-opacity-40 rounded-full text-sm">Context Awareness</span>
                    </div>
                </div>
                <div class="flex-shrink-0">
                    <div class="w-64 h-64 rounded-xl overflow-hidden shadow-lg">
                        <img 
                        src="https://source.unsplash.com/random/400x400/?technology,ai" 
                        alt="AI technology" class="w-full h-full object-cover" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="testimonials" class="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-gradient-to-b from-purple-900/10 to-transparent">
        <div class="text-center mb-16">
            <h2 class="text-3xl md:text-4xl font-bold mb-4">What Our Users Say</h2>
            <p class="text-gray-400 max-w-2xl mx-auto">Join thousands of music lovers who transformed their listening experience</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="glass-card p-6 rounded-xl">
                ...
                <p class="text-gray-300">"Harmoniq's AI recommendations are scarily accurate. It introduced me to my new favorite band before I even knew they existed!"</p>
            </div>
            ...
            <div class="glass-card p-6 rounded-xl">
                ...
                <p class="text-gray-300">"As a DJ, the tagging system has revolutionized how I organize my library. I can find the perfect track for any mood or crowd in seconds."</p>
            </div>
            ...
            <div class="glass-card p-6 rounded-xl">
                ...
                <p class="text-gray-300">"The collaborative playlists have brought my friend group closer together during lockdown. We take turns adding songs and it's become our virtual hangout."</p>
            </div>
        </div>
    </section>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
                <div class="flex items-center mb-4">
                    ...
                    <span class="text-xl font-bold">Harmoniq</span>
                </div>
                <p class="text-gray-400 text-sm">Revolutionizing music discovery through AI and smart metadata.</p>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="#" class="text-gray-400 hover:text-white text-sm">Apps</a></li>
